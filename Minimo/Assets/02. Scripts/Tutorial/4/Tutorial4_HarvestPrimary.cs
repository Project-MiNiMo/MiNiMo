...
public class Tutorial4_HarvestPrimary : TutorialBase
{
    ...
    public override void StartTutorial()
    {
        ...
        App.GetManager<QuestManager>().StartQuest("HarvestPrimary_Crop");
        App.GetManager<QuestManager>().StartQuest("HarvestPrimary_Fruit");
